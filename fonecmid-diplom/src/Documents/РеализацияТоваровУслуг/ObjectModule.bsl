...
КонецПроцедуры
//Начало вставки: Задача: ONEC-MID-DIPLOM. Автор: Ложечкин А.А. Дата: 13.01.2025	
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	Если ЗначениеЗаполнено(КонстантаРаботы) и 
		...
		Если Дата >= Договор.ВКМ_ДатаНачалаДействияДоговора и Дата <= Договор.ВКМ_ДатаОкончанияДействияДоговора тогда    
