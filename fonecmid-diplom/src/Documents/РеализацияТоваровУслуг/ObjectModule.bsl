...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	//+ Исправление замечаний 21.07.2025
	РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВКМ_ДатаНачалаДействияДоговора,ВКМ_ДатаОкончанияДействияДоговора,ВКМ_СуммаАбонентскойПлаты");
	//- Исправление замечаний 21.07.2025
	...
	Если ЗначениеЗаполнено(КонстантаРаботы) и 
		...
		//ДанныеДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВКМ_СуммаАбонентскойПлаты, ВКМ_ДатаНачалаДействияДоговора, ВКМ_ДатаОкончанияДействияДоговора"); //было 
		
		Если Дата >= РеквизитыДоговора.ВКМ_ДатаНачалаДействияДоговора и Дата <= РеквизитыДоговора.ВКМ_ДатаОкончанияДействияДоговора тогда    
			Если РеквизитыДоговора.ВКМ_СуммаАбонентскойПлаты > 0 тогда
				...
				СтрокаУслугиОбслуживание.Цена = РеквизитыДоговора.ВКМ_СуммаАбонентскойПлаты;
				СтрокаУслугиОбслуживание.Сумма = РеквизитыДоговора.ВКМ_СуммаАбонентскойПлаты;	
